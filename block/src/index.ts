...
export type TcrdiscoEnrichmentBlockContract = BlockContract;
export type TcrdiscoEnrichmentBlockOutputs  = BlockOutputs;
export type TcrdiscoEnrichmentBlockData     = BlockData;
export const TcrdiscoEnrichmentBlockPointer = BlockPointer;
